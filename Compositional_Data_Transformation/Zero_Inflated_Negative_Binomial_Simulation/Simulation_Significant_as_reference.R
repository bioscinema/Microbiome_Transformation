...
generate_results_list <- function(num_datasets = 100, num_elements = 50) {
  ...
  for (i in 1:num_datasets) {
    ...
    results_list[[data_name]] <- c(rep(FALSE, num_elements / 2), rep(TRUE, num_elements / 2))
  }
...
write.csv(summary_results, "/home/yxz3116/summary_significant_as_reference.csv", row.names = FALSE)
